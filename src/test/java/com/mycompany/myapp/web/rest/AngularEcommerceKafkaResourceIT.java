...
class AngularEcommerceKafkaResourceIT {
    ...
    void setup() {
        ...
        AngularEcommerceKafkaResource kafkaResource = new AngularEcommerceKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/angular-ecommerce-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/angular-ecommerce-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
