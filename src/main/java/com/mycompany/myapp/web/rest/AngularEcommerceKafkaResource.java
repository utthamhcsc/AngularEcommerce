...
@RestController
@RequestMapping("/api/angular-ecommerce-kafka")
public class AngularEcommerceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AngularEcommerceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AngularEcommerceKafkaResource(KafkaProperties kafkaProperties) {
